...
// I found Activity 3 very difficult and frustrating. I spent quite some time testing various different methods
// to the point that I had code which was a Frankenstein monster mish mash of non-working parts.
// Below is essentially your alterantive gist solution which was closer to what I was trying initially. I have 
// modified it in small ways to test different options but I mostly wanted to write down and work through your solution 
// alongside my own code to understand how it worked. As such the work below is not significantly 'mine' enough 
// to consider. It's just there so my activity set is complete. Thank you!
